...
public class OrderController {
	...
	public JSONObject getMhkReportDataList(String sign, String timestamp, String serviceNumber) {
		...
		r1.setPdfFile("http://yjk-test-1258316165.cos.ap-shanghai.myqcloud.com/mhk_pdf/89999201810000801_v485627_20190726145632.pdf");
 		r1.setServiceNumber("2019081315");
		r1.setVid("100000000");
		r1.setType("1");
		Report r2 = new Report();
		r2.setPdfFile("http://yjk-test-1258316165.cos.ap-shanghai.myqcloud.com/mhk_pdf/89999201810000801_v485627_20190726145632.pdf");
 		r2.setServiceNumber("2019081315");
		r2.setVid("100000001");
		r2.setType("2");
		Report r3 = new Report();
		r3.setPdfFile("http://yjk-test-1258316165.cos.ap-shanghai.myqcloud.com/mhk_pdf/89999201810000801_v485627_20190726145632.pdf");
